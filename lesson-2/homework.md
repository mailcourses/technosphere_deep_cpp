...
- При вызове makeAllocator аллоцируется динамическая память указанного размера (при помощи malloc);
...
- free (если был использован malloc) вызывается только в деструкторе!
